...
#include "ros2_robot/robot_system.hpp"
  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  {
    // has exactly two states and one command interface on each joint
...
hardware_interface::return_type ros2_robot ::DiffDriveArduinoHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (!comms_.connected())
  {
...
PLUGINLIB_EXPORT_CLASS(
  ros2_robot::DiffDriveArduinoHardware, hardware_interface::SystemInterface)
