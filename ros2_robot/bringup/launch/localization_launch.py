...
def generate_launch_description():
    ...
    'slam_params_file',
    default_value='/home/pi/ros2_main/src/ros2_robot/bringup/config/local_params_online_async.yaml',  # Use the absolute path you provided
    ...
    namespace='',
    remappings=[
        ('/odom', '/diffbot_base_controller/odom'),  # Add this critical remapping
        ('/tf', 'tf'),
        ('/tf_static', 'tf_static')
    ]
)
